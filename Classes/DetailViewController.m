...
- (void)viewDidLoad {
	...
	htmlFile = [[NSBundle mainBundle] pathForResource:selectedProduce ofType:@"html"];
	...
	query = [NSMutableString stringWithFormat:@"select template,col1,col2,col3,col4,col5,col6,col7,col8,col9,col10,col11,col12,col13,col14,col15,col16,col17,col18,col19,col20,col21,col22 from detail where product = '%@",selectedProduce]; 
	[query appendString:@"' and category = '"];
	[query appendString:selectedCategory];
	[query appendString:@"'"];
